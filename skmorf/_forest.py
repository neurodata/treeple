...
from .tree import ImagePatchDecisionTreeClassifier
...
class ManifoldObliqueRandomForestClassifier(ForestClassifier):
    ...
    A manifold oblique random forest is a meta estimator similar to a random
    forest that fits a number of oblique decision tree classifiers with
    a manifold assumption on the underlying data.
