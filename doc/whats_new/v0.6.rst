...
- |Enhancement| :mod:`sktree.datasets.marronwand` now
  has a generative model based on Marron and Wand 1992 that will enable
  analytical computation of (conditional) mutual information, by `Adam Li`_ (:pr:`#185`).
