...
from sklearn.tree._tree import _check_n_classes, _check_node_ndarray, _check_value_ndarray
...
@pytest.mark.parametrize("clf", [DecisionTreeClassifier(), ObliqueDecisionTreeClassifier()])
